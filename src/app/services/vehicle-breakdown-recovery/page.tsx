...
const title = "24/7 Vehicle Breakdown Recovery | FSR Recovery Groups";
const description = "Need 24/7 vehicle breakdown recovery? FSR Recovery Groups provides professional car and van recovery in Darlington and surrounding areas. Call now.";
...
const benefits: ServiceCard[] = [
  ...
  { icon: "fa-solid fa-map-location-dot", title: "Local Recovery Support", text: "Based in Darlington, FSR Recovery Groups provides breakdown recovery across Darlington and surrounding areas." },
];
const faqs: ServiceFaq[] = [
  ["Is your vehicle breakdown recovery available 24/7?", "Yes. FSR Recovery Groups provides 24/7 vehicle breakdown recovery, including daytime, overnight and weekend assistance."],
  ...
  ["What if the problem can be dealt with at the roadside?", "FSR Recovery Groups also provides Roadside Assistance. If roadside help may be more suitable than transporting the vehicle, the available options can be discussed when you contact us."],
  ...
  ["Do you provide breakdown recovery in Darlington?", "Yes. FSR Recovery Groups is based in Darlington and provides breakdown recovery across Darlington and surrounding areas. Contact us with your location to confirm availability."],
