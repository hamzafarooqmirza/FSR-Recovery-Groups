...
export const metadata: Metadata = {
  ...
  openGraph: { title, description, url: path, type: "website", siteName: "FSR Recovery Group", images: [{ url: "/images/FSR-open-graph.webp", width: 1200, height: 630, alt: "FSR Recovery Group roadside assistance service" }] },
  twitter: { card: "summary_large_image", title, description, images: ["/images/FSR-open-graph.webp"] },
};
