...
const title = "24/7 Roadside Assistance | FSR Recovery Groups";
const description = "Need roadside assistance? FSR Recovery Groups provides 24/7 roadside help for common vehicle problems in Darlington and surrounding areas. Call now.";
const path = "/services/roadside-assistance";

export const metadata: Metadata = {
  title: { absolute: title }, description,
  alternates: { canonical: path }, robots: { index: true, follow: true },
  openGraph: { title, description, url: path, type: "website", siteName: "FSR Recovery Groups" },
...
const benefits: ServiceCard[] = [
  ...
  { icon: "fa-solid fa-map-location-dot", title: "Local Support", text: "Based in Darlington, FSR Recovery Groups provides roadside assistance across Darlington and surrounding areas." },
];
const faqs: ServiceFaq[] = [
  ...
  ["Is your roadside assistance available 24/7?", "Yes. FSR Recovery Groups provides roadside assistance 24 hours a day, including daytime, overnight and weekend support."],
  ...
  ["Can you help with a flat battery?", "Yes. FSR Recovery Groups provides Jumpstart Services for suitable vehicles with weak or discharged batteries."],
  ...
  ["What happens if roadside assistance cannot fix the problem?", "If your vehicle remains undriveable or cannot safely continue, FSR Recovery Groups can arrange professional vehicle breakdown recovery to an agreed destination."],
  ...
  ["Do you provide roadside assistance in Darlington?", "Yes. FSR Recovery Groups is based in Darlington and provides roadside assistance across Darlington and surrounding areas. Contact us with your location to confirm availability."],
  ...
  return <><Header activePath="/services" /><main>
    <section className="service-hero relative isolate min-h-[680px] overflow-hidden bg-navy text-white">
      ...
      <div className="container-site flex min-h-[680px] items-center py-20"><div className="fade-up max-w-3xl">
        ...
        <p className="my-6 max-w-2xl text-lg leading-8 text-white/80">Unexpected vehicle trouble can leave you stranded even when your vehicle does not immediately need full recovery. FSR Recovery Groups provides professional 24/7 roadside assistance for drivers who need help with common vehicle problems at their current location.</p>
        <ContactButtons dark callLabel="Call +44 7888 502989" whatsappLabel="WhatsApp for Roadside Help" />
    ...
    <section className="py-16 sm:py-24"><div className="container-site grid items-center gap-10 lg:grid-cols-2 lg:gap-16"><div className="fade-up"><Eyebrow>Local Roadside Support</Eyebrow><h2 className="text-3xl font-extrabold sm:text-4xl">Roadside Assistance in Darlington and Surrounding Areas</h2><div className="my-6 space-y-4 leading-7 text-navy/70"><p>FSR Recovery Groups is based at 135 Gladstone St, Darlington DL3 6LB and provides roadside assistance for drivers in Darlington and surrounding areas.</p><p>Whether your vehicle develops a problem near home, outside work, in a car park or while travelling through the area, contact us with your location and vehicle details.</p><p>If you are outside Darlington, call or WhatsApp us with your location so we can confirm whether assistance is available.</p></div><address className="mb-7 rounded-2xl bg-slate-100 p-5 not-italic leading-7"><strong>FSR Recovery Groups</strong><br/>135 Gladstone St, Darlington DL3 6LB, United Kingdom<br/><a href="tel:+447888502989" className="font-bold text-red">+44 7888 502989</a></address><div className="flex flex-col gap-3 sm:flex-row"><a href="tel:+447888502989" className="rounded-full bg-red px-6 py-3.5 text-center font-bold text-white">Call for Roadside Help</a><Link href="/areas" className="rounded-full border border-navy/20 px-6 py-3.5 text-center font-bold">View Areas Covered</Link></div></div><div className="fade-up relative min-h-[480px] overflow-hidden rounded-3xl"><Image src="/images/service-roadside.jpg" alt="Vehicle receiving roadside support near Darlington" fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover" /></div></div></section>

    <section className="bg-slate-50 py-16 sm:py-24"><div className="container-site"><SectionHeading eyebrow="The Right Help for the Situation" title="Roadside Assistance or Vehicle Recovery?" /><div className="grid gap-6 lg:grid-cols-2">{[["Roadside Assistance","Roadside assistance may be suitable when the problem can potentially be dealt with at your current location, such as a flat battery, fuel issue or suitable tyre problem.","The aim is to provide the appropriate help without transporting the vehicle unnecessarily.","/images/service-jumpstart.jpg","Technician providing roadside help for a car"],["Vehicle Breakdown Recovery","If the vehicle remains undriveable or cannot safely continue, professional recovery may be the better option.","FSR Recovery Groups can transport the vehicle to an agreed garage, home address or another suitable destination.","/images/service-breakdown.jpg","Vehicle prepared for professional breakdown recovery"]].map(([t,a,b,img,alt])=><article key={t} className="fade-up overflow-hidden rounded-3xl bg-navy text-white"><div className="relative h-64"><Image src={img} alt={alt} fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover" /></div><div className="p-7"><h3 className="mb-3 text-2xl font-bold">{t}</h3><p className="mb-3 leading-7 text-white/70">{a}</p><p className="leading-7 text-white/70">{b}</p></div></article>)}</div><div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row"><a href="tel:+447888502989" className="rounded-full bg-red px-7 py-4 font-bold text-white">Request Roadside Assistance</a><Link href="/services/vehicle-breakdown-recovery" className="rounded-full border border-navy/20 px-7 py-4 font-bold text-navy">View 24/7 Vehicle Breakdown Recovery</Link></div></div></section>

    <section className="bg-navy py-16 text-white sm:py-24"><div className="container-site"><div className="[&_h2]:!text-white"><SectionHeading eyebrow="More Ways We Can Help" title="Related Roadside & Recovery Services" /></div><div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4"><RelatedCard title="Jumpstart Services" text="Professional battery assistance when a weak or flat battery prevents your vehicle from starting." href="/services" icon="fa-solid fa-car-battery"/><RelatedCard title="Changing Spare Tyre" text="Help changing to an available spare tyre when a tyre problem leaves you unable to continue." href="/services" icon="fa-solid fa-circle-dot"/><RelatedCard title="Refueling" text="Roadside assistance when your vehicle unexpectedly runs out of fuel." href="/services" icon="fa-solid fa-gas-pump"/><RelatedCard title="Winch Out" text="Professional vehicle extraction when your car or van becomes stuck and cannot regain traction." href="/services" icon="fa-solid fa-truck-monster"/></div><div className="mt-9 flex justify-center"><Link href="/contact" className="font-bold text-white underline decoration-red decoration-2 underline-offset-4">Contact FSR Recovery Groups</Link></div></div></section>
