...
const title = "24/7 Jumpstart Services | FSR Recovery Groups";
const description = "Car won't start? FSR Recovery Groups provides 24/7 jumpstart and flat battery assistance for cars and suitable vans in Darlington and nearby areas.";
...
const benefits: ServiceCard[] = [
  ...
  { icon: "fa-solid fa-map-location-dot", title: "Local Support", text: "Based in Darlington, FSR Recovery Groups provides roadside and vehicle recovery services across Darlington and surrounding areas." },
];
const faqs: ServiceFaq[] = [
  ["Do you provide jumpstart services 24/7?", "Yes. FSR Recovery Groups provides 24/7 roadside assistance, including jumpstart support for suitable cars and light vans."],
  ...
  ["Do you replace car batteries?", "Our confirmed service is jumpstart assistance. We do not advertise battery replacement; arrange professional inspection if your battery may need replacing."],
  ["What happens if the jumpstart does not work?", "If the vehicle remains unable to start or cannot safely continue, FSR Recovery Groups can discuss vehicle breakdown recovery to an agreed destination."],
  ["Do you offer jumpstart services in Darlington?", "Yes. FSR Recovery Groups is based in Darlington and provides roadside assistance in Darlington and surrounding areas. Contact us with your location to confirm availability."],
  ...
  return <><Header activePath="/services" /><main>
    <section className="service-hero relative isolate min-h-[680px] overflow-hidden bg-navy text-white">
      ...
      <div className="container-site flex min-h-[680px] items-center py-20"><div className="fade-up max-w-3xl">
        ...
        <p className="my-6 max-w-2xl text-lg leading-8 text-white/80">A flat or weak battery can leave your car or van unable to start when you need it most. FSR Recovery Groups provides professional 24/7 jumpstart services for suitable vehicles, helping drivers get the right roadside assistance when battery power is the problem.</p>
        <ContactButtons dark callLabel="Call +44 7888 502989" whatsappLabel="WhatsApp for a Jumpstart" />
    ...
    <section className="py-16 sm:py-24"><div className="container-site grid items-center gap-10 lg:grid-cols-2 lg:gap-16"><div className="fade-up"><Eyebrow>Local Battery Assistance</Eyebrow><h2 className="text-3xl font-extrabold sm:text-4xl">Jumpstart Services in Darlington and Surrounding Areas</h2><div className="my-6 space-y-4 leading-7 text-navy/70"><p>FSR Recovery Groups is based at 135 Gladstone St, Darlington DL3 6LB and provides roadside assistance for drivers with battery-related starting problems in Darlington and surrounding areas.</p><p>If your car or van will not start at home, outside work, in a car park or at another suitable accessible location, contact us with your vehicle details and location.</p><p>If you are outside Darlington, call or WhatsApp us with your location so we can confirm whether assistance is available.</p></div><address className="mb-7 rounded-2xl bg-slate-100 p-5 not-italic leading-7"><strong>FSR Recovery Groups</strong><br/>135 Gladstone St, Darlington DL3 6LB, United Kingdom<br/><a href="tel:+447888502989" className="font-bold text-red">+44 7888 502989</a></address><div className="flex flex-col gap-3 sm:flex-row"><a href="tel:+447888502989" className="rounded-full bg-red px-6 py-3.5 text-center font-bold text-white">Call for a Jumpstart</a><Link href="/areas" className="rounded-full border border-navy/20 px-6 py-3.5 text-center font-bold">View Areas Covered</Link></div></div><div className="fade-up relative min-h-[480px] overflow-hidden rounded-3xl"><Image src="/images/service-jumpstart.jpg" alt="Flat battery roadside assistance near Darlington" fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover" /></div></div></section>

    <section className="bg-slate-50 py-16 sm:py-24"><div className="container-site"><SectionHeading eyebrow="Know the Next Step" title="Jumpstart Assistance or Vehicle Recovery?" /><div className="grid gap-6 lg:grid-cols-2">{[["Jumpstart Assistance","A jumpstart may be appropriate when a weak or discharged battery is preventing the engine from starting but the vehicle is otherwise suitable for roadside assistance.","The aim is to provide enough starting support for the vehicle to get running where appropriate.","/images/service-jumpstart.jpg","Technician providing roadside help for a car"],["Vehicle Breakdown Recovery","If the vehicle still will not start after suitable assistance, another electrical, starter, charging or mechanical issue may be involved.","If the vehicle remains undriveable, FSR Recovery Groups can arrange professional recovery to an agreed garage or destination.","/images/service-breakdown.jpg","Vehicle prepared for professional breakdown recovery"]].map(([t,a,b,img,alt])=><article key={t} className="fade-up overflow-hidden rounded-3xl bg-navy text-white"><div className="relative h-64"><Image src={img} alt={alt} fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover" /></div><div className="p-7"><h3 className="mb-3 text-2xl font-bold">{t}</h3><p className="mb-3 leading-7 text-white/70">{a}</p><p className="leading-7 text-white/70">{b}</p></div></article>)}</div><div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row"><a href="tel:+447888502989" className="rounded-full bg-red px-7 py-4 font-bold text-white">Request a Jumpstart</a><Link href="/services/vehicle-breakdown-recovery" className="rounded-full border border-navy/20 px-7 py-4 font-bold text-navy">View 24/7 Vehicle Breakdown Recovery</Link></div></div></section>

    <section className="bg-navy py-16 text-white sm:py-24"><div className="container-site"><div className="[&_h2]:!text-white"><SectionHeading eyebrow="More Ways We Can Help" title="Related Roadside & Recovery Services" /></div><div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4"><RelatedCard title="Roadside Assistance" text="Professional help for suitable vehicle problems at your current location." href="/services/roadside-assistance" icon="fa-solid fa-screwdriver-wrench"/><RelatedCard title="24/7 Vehicle Breakdown Recovery" text="Recovery when your vehicle cannot be restarted or safely continue its journey." href="/services/vehicle-breakdown-recovery" icon="fa-solid fa-truck-pickup"/><RelatedCard title="Changing Spare Tyre" text="Roadside help when a tyre problem leaves you unable to continue and a suitable spare is available." href="/services#changing-spare-tyre" icon="fa-solid fa-circle-dot"/><RelatedCard title="Refueling" text="Assistance when your vehicle has stopped because it has unexpectedly run out of fuel." href="/services#refueling" icon="fa-solid fa-gas-pump"/></div><div className="mt-9 flex justify-center"><Link href="/contact" className="font-bold text-white underline decoration-red decoration-2 underline-offset-4">Contact FSR Recovery Groups</Link></div></div></section>
