...
export const metadata: Metadata = {
  ...
  openGraph: { title, description, url: path, type: "website", siteName: "FSR Recovery Group", images: [{ url: "/images/service-jumpstart.jpg", alt: "Professional jumpstart assistance for a car" }] },
