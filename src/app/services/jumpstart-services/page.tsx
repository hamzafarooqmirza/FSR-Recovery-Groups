...
export const metadata: Metadata = {
  ...
  openGraph: { title, description, url: path, type: "website", siteName: "FSR Recovery Group", images: [{ url: "/images/FSR-open-graph.webp", width: 1200, height: 630, alt: "FSR Recovery Group jumpstart service" }] },
...
const faqs: ServiceFaq[] = [
  ...
  ["Do you replace car batteries?", "FSR Recovery Group's confirmed service is jumpstart assistance. If you believe the battery needs replacing, arrange an inspection with a suitable garage or battery specialist."],
