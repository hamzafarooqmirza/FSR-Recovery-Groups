...
// Positions, sizes and rotation measured directly off the source PDF (pixel
// centroid + bounding box of each isolated navy mark), converted into this
// SVG's viewBox coordinates. The design has exactly three of these accent
// dashes along the main wave — not a continuous dashed line.
const dashes = [
  { x: 197, y: 93, rot: -13.7, w: 55 },
  { x: 415, y: 82, rot: -4.8, w: 150 },
  { x: 839, y: 164, rot: 17, w: 120 },
];
